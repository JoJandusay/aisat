<x-layouts.app>
    ...
    <form action="{{ route('students.update', $student) }}" method="post">
                    ...
                    <div class="grid gap-6 mb-6 md:grid-cols-4">
                        <div>
                            <label for="student_code"
                                ...
                                ID</label>
                            <input type="text" disabled id="student_code" name="student_code"
                        ...
                        <div>
                            <label for="firstname"
                                ...
                                name</label>
                            <input type="text" disabled id="firstname" name="firstname"
                        ...
                        <div>
                            <label for="middlename"
                                ...
                                name</label>
                            <input type="text" disabled id="middlename" name="middlename"
                        ...
                        <div>
                            ...
                            <select id="level" name="level"
                                ...
                                @foreach ($levels as $level)
                                    <option value="{{ $level }}" @selected(old('level', $student->level) == $level)>
                                        {{ $level }}</option>
                                @endforeach
                            </select>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex pt-4">
                                <div class="flex items-center me-4">
                                    <input disabled id="male" type="radio" value="Male" name="sex"
                                        {{ old('sex', $student->sex) == 'Male' ? 'checked' : '' }}
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="male"
                                        class="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Male</label>
                                </div>
                                <div class="flex items-center me-4">
                                    <input disabled id="female" type="radio" value="Female" name="sex"
                                        {{ old('sex', $student->sex) == 'Female' ? 'checked' : '' }}
                                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    <label for="female"
                        ...
                        <div class="col-start-1">
                            <label for="father_lastname"
                                ...
                                Name</label>
                            <input type="text" disabled id="father_lastname" name="father_lastname"
                        ...
                        <div>
                            <label for="father_firstname"
                                ...
                                Name</label>
                            <input type="text" disabled id="father_firstname" name="father_firstname"
                        ...
                        <div>
                            <label for="father_middlename"
                                ...
                                Name</label>
                            <input type="text" disabled id="father_middlename" name="father_middlename"
                        ...
                        <div>
                            <label for="mother_lastname"
                                ...
                                Name</label>
                            <input type="text" disabled id="mother_lastname" name="mother_lastname"
                        ...
                        <div>
                            <label for="mother_firstname"
                                ...
                                Name</label>
                            <input type="text" disabled id="mother_firstname" name="mother_firstname"
                        ...
                        <div>
                            <label for="mother_middlename"
                                ...
                                Name</label>
                            <input type="text" disabled id="mother_middlename" name="mother_middlename"
                        ...
                        <div>
                            ...
                            <input type="tel" id="father_mobile_number" name="mother_mobile_number"
                                value="{{ old('mother_mobile_number', $student->mother_mobile_number) }}"
                                class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                placeholder="123-45-678" />
                        </div>
                    </div>
                        ...
                        <div class="grid gap-6 mb-6 md:grid-cols-4">
                            ...
                            <div class="md:col-span-2 pl-8">
                                ...
                                <input type="text" id="1st_vaccine_name" name="first_vaccine_name"
                                    value="{{ old('first_vaccine_name', $student->first_vaccine_name) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <div class="md:col-span-2 pl-8">
                                ...
                                <input type="date" id="first_vaccine_date" name="first_vaccine_date"
                                    value="{{ old('first_vaccine_date', $student->first_vaccine_date) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            </div>
                            ...
                            <div class="md:col-span-2 pl-8">
                                ...
                                <input type="text" id="second_vaccine_name" name="second_vaccine_name"
                                    value="{{ old('second_vaccine_name', $student->second_vaccine_name) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Enter vaccine name" />
                            </div>
                            <div class="md:col-span-2 pl-8">
                                ...
                                <input type="date" id="second_vaccine_date" name="second_vaccine_date"
                                    value="{{ old('second_vaccine_date', $student->second_vaccine_date) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            </div>
                            ...
                            <div class="md:col-span-2 pl-8">
                                ...
                                <input type="text" id="booster_name" name="booster_name"
                                    value="{{ old('booster_name', $student->booster_name) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Enter vaccine name" />
                            </div>
                            <div class="md:col-span-2 pl-8">
                                ...
                                <input type="date" id="booster_date" name="booster_date"
                                    value="{{ old('booster_date', $student->booster_date) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            </div>
                            ...
                            <div class="pl-8">
                                ...
                                <input type="date" id="had_covid" name="had_covid"
                                    value="{{ old('had_covid', $student->had_covid) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                            </div>
                            <div class="md:col-span-4">
                                3. Allergies
                            ...
                            <div class="col-start-1 col-span-full pl-8">
                                ...
                                <textarea
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    placeholder="Cause / Reaction / Treatment" name="allergies" id="allergies" cols="100" rows="5">{{ old('allergies', $student->allergies) }}</textarea>
                            </div>
                            <div class="md:col-span-4">
                                4. Medication
                            </div>
                            <div class="md:col-span-2 pl-8">
                                ...
                                <input type="text" id="medication_name" name="medication_name"
                                    value="{{ old('medication_name', $student->medication_name) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <div class="flex items-end">
                                ...
                                <input type="text" id="used_to_treat" name="used_to_treat"
                                    value="{{ old('used_to_treat', $student->used_to_treat) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <div class="flex items-end">
                                ...
                                <input type="text" id="dose_time" name="dose_time"
                                    value="{{ old('dose_time', $student->dose_time) }}"
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                            ...
                            <div class="col-start-1 col-span-full pl-8">
                                ...
                                <textarea
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    name="ongoing_treatment" id="ongoing_treatment" cols="100" rows="5">{{ old('ongoing_treatment', $student->ongoing_treatment) }}</textarea>
                            </div>
                            <div class="md:col-span-4">
                                6. Any medical
                            ...
                            <div class="col-start-1 col-span-full pl-8">
                                ...
                                <textarea
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    name="condition_not_allow_pe" id="condition_not_allow_pe" cols="100" rows="5">{{ old('condition_not_allow_pe', $student->condition_not_allow_pe) }}</textarea>
                            </div>
                                ...
                                <div class="flex pt-4">
                                    ...
                                    <div class="flex items-center me-4">
                                        <input id="contact-lenses" type="radio" value="Contact Lenses"
                                            {{ old('visual_dificulties', $student->visual_dificulties) == 'Contact Lenses' ? 'checked' : '' }}
                                            name="visual_dificulties"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                    ...
                                    <div class="flex items-center me-4">
                                        <input id="glasses" type="radio" value="Glasses"
                                            {{ old('visual_dificulties', $student->visual_dificulties) == 'Glasses' ? 'checked' : '' }}
                                            name="visual_dificulties"
                                            class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                        <label for="glasses"
                            ...
                            <div class="col-start-1 col-span-full pl-8">
                                ...
                                <textarea
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    name="hearing_speech_difficulties" id="hearing_speech_difficulties" cols="100" rows="5">{{ old('hearing_speech_difficulties', $student->hearing_speech_difficulties) }}</textarea>
                            </div>
                            <div class="md:col-span-4">
                                9. Has your child
                            ...
                            <div class="col-start-1 col-span-full pl-8">
                                ...
                                <textarea
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    name="medical_conditions" id="medical_conditions" cols="100" rows="5">{{ old('medical_conditions', $student->medical_conditions) }}</textarea>
                            </div>
                            <div class="md:col-span-4">
                                10. Other
                            ...
                            <div class="col-start-1 col-span-full pl-8">
                                ...
                                <textarea
                                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                    name="other_medical_conditions" id="other_medical_conditions" cols="100" rows="5">{{ old('other_medical_conditions', $student->other_medical_conditions) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
        ...
        <div class="flex flex-col md:flex-row gap-2 pb-10">
            <button type="submit"
                class="block text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save
                changes</button>
            <a href="{{ route('students.index') }}"
                class="block text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-gray-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-3 text-center dark:bg-gray-600 dark:hover:bg-gray-700 dark:focus:ring-gray-800">Go
                back</a>
        </div>
    </form>
